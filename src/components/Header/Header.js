      ...
      <div className={`mobile-menu-overlay ${isMobileMenuOpen ? 'open' : ''}`}>
        <div className="mobile-menu">
          <ul className="mobile-nav-links">
            <li>
              {/* <Link to="/" onClick={toggleMobileMenu}>How It Works <FontAwesomeIcon icon={faCaretDown} /></Link> */}
            ...
            <li>
              {/* <Link to="/about-us" onClick={toggleMobileMenu}>About Us <FontAwesomeIcon icon={faCaretDown} /></Link> */}
              <button onClick={() => handleDropdownToggle('how-it-works')}>About Us<FontAwesomeIcon icon={faCaretDown} /></button>
